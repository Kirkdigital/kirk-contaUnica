                            ...
                            <form method="POST" action="{{ route('people.store') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" name="email" type="email"
                                                    placeholder="joao@live.com" autocomplete="joao@live.com" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-6">
                                        ...
                                        <input class="form-control" name="mobile" type="tel" placeholder="(11) 99999-9999"
                                            pattern="([0-9]{2}) [0-9]{5}-[0-9]{4}" required> <span class="help-block">Format
                                            (99) 99999-9999</span>
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label for="ccyear">Data de Nascimento</label>
                                        <input class="form-control" name="birth_at" type="date" placeholder="date"><span
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" action="" method="post">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" placeholder="Enter Email.." autocomplete="email"
                                            disabled><span class="help-block">Please enter your email</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" placeholder="Enter Password.."
                                            autocomplete="current-password" disabled><span class="help-block">Please enter
                                            your password</span>
                                    </div>
                                </div>
                        </div>
