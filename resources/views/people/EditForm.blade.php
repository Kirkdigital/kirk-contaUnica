            ...
            <div class="form-group row">
                ...
                <div class="col-md-9 col-form-label">
                  ...
                  <div class="form-check form-check-inline mr-1">
                    ...
                    <label class="form-check-label" for="sex">Feminino</label>
                  </div>
                </div>
              </div>
          </div>
          ...
          <div class="card-body">
            <form class="form-horizontal" action="" method="post">
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input class="form-control" id="hf-email" type="email" name="hf-email" placeholder="Enter Email.." autocomplete="email" disabled><span class="help-block">Please enter your email</span>
                </div>
              </div>
              <div class="form-group row">
                <label class="col-md-3 col-form-label" for="hf-password">Password</label>
                <div class="col-md-9">
                  <input class="form-control" id="hf-password" type="password" name="hf-password" placeholder="Enter Password.." autocomplete="current-password" disabled><span class="help-block">Please enter your password</span>
                </div>
              </div>
