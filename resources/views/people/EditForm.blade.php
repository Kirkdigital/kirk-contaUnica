                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input class="form-control" id="birth_at" name="birth_at"
                                                            type="date" placeholder="date" value="{{ $people->birth_at }}"
                                                            @if ($campo->obg_birth == true)
                                                        required
                                                        @endif
                                                        >
                                                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <textarea class="form-control" name="note" rows="9" placeholder="Content.."
                                {{ $people->note }} @if ($campo->obg_note == true)
                                                                    required
                                                                    @endif
                                                                    ></textarea>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" placeholder="Liberar o acesso"
                                    value="@if ($people->user_id) {{ $people->acesso->email }} @endif" autocomplete="email" disabled>
                            </div>
                        </div>
                </div>
            </div>
