                        ...
                        <div class="col-md-12">
                          ...
                          <div class="row">
                            <div class="col-sm-12">
                              <div class="form-group">
                                ...
                                <input class="form-control" id='name' name="name" type="text" value='{{ Auth::user()->name }}' maxlength="50" required>
                              </div>
                            </div>
                            </div>
                          </div>
                          ...
                          <div class="row">
                            <div class="form-group col-sm-4">
                              ...
                              <input class="form-control" name="mobile" type="text" placeholder="11 99999-9999"  pattern="([0-9]{2}) [0-9]{5}-[0-9]{4}" value="{{ Auth::user()->mobile }}" maxlength="15">
                ...
                <div class="row setup-content" id="step-3">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" name="address" type="text" placeholder="Enter street name" maxlength="200">
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-sm-5">
                        ...
                        <input class="form-control" name="city" type="text" placeholder="Enter your city" maxlength="15">
                        </div>
                      </div>
                      <div class="form-group col-sm-3">
                      ...
                      <input class="form-control" name="state" type="text" placeholder="State" placeholder="SP" maxlength="2">
                      </div>
                    </div>
                      <div class="form-group col-sm-4">
                        ...
                        <input class="form-control" name="cep" type="number" placeholder="Postal Code" maxlength="8">
                        </div>
                      </div>
                    </div>
                    <!-- /.row-->
