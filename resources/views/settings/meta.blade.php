                            ...
                            <div class="col-sm-12"><strong>Configuração de Metas</strong>
                                <div class="card-header">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <label for="name">Visitante</label>
                                            <input class="form-control" id="visitante_ano" name="visitante_ano"
                                                type="number" value="{{ $settings->visitante_ano }}">
                                        </div>
                                        <div class="col-sm-2">
                                        ...
                                        <div class="col-sm-2">
                                            <label for="name">Conversão</label>
                                            <input class="form-control" id="conversao_ano" name="conversao_ano"
                                                type="number" value="{{ $settings->conversao_ano }}">
                                        </div>
                                        <div class="col-sm-2">
                                            <label for="name">Pessoa</label>
                                    ...
                                    -->
                                        <div class="col-sm-3">
                                            ...
                                            <input class="form-control" id="fin_dizimo_ano" name="fin_dizimo_ano"
                                                type="float" value="{{ $settings->fin_dizimo_ano }}">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="name">Oferta Ano</label>
                                            <input class="form-control" id="fin_oferta_ano" name="fin_oferta_ano"
                                                type="float" value="{{ $settings->fin_oferta_ano }}">
                                        </div>
                                        <div class="col-sm-3">
                                            <label for="name">Despesa Ano</label>
                                            <input class="form-control" id="fin_despesa_ano" name="fin_despesa_ano"
                                                type="float" value="{{ $settings->fin_despesa_ano }}">
                                        </div>
                                        <div class="col-sm-3">
