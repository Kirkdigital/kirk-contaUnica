                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="delete_people" type="checkbox"
                                            ...
                                            <td> <label
                                                    class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                    <input class="c-switch-input" name="view_precadastro" type="checkbox"
                                            ...
                                            <td> <label
                                                    class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                    <input class="c-switch-input" name="edit_precadastro" type="checkbox"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="delete_group" type="checkbox"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="view_message" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="edit_message" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="delete_message" type="checkbox"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="add_calendar" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="view_calendar" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="edit_calendar" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="delete_calendar" type="checkbox"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="view_financial" type="checkbox"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="view_periodo" type="checkbox"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="home_financeiro" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="home_social" type="checkbox"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="settings_email" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="settings_meta" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="settings_social" type="checkbox"
                                                ...
                                                <td>
                                                    <label
                                                        class="c-switch c-switch-label c-switch-pill c-switch-primary c-switch-sm">
                                                        <input class="c-switch-input" name="settings_roles" type="checkbox"
